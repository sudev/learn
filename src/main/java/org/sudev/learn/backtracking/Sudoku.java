...
public class Sudoku {
    ...
    /**
     * public static int[][] GRID_TO_SOLVE = { {9, 0, 0, 1, 0, 0, 0, 0, 5}, {0, 0,
     * 5, 0, 9, 0, 2, 0, 1}, {8, 0, 0, 0, 4, 0, 0, 0, 0}, {0, 0, 0, 0, 8, 0, 0, 0,
     * 0}, {0, 0, 0, 7, 0, 0, 0, 0, 0}, {0, 0, 0, 0, 2, 6, 0, 0, 9}, {2, 0, 0, 3, 0,
     * 0, 0, 0, 6}, {0, 0, 0, 2, 0, 0, 9, 0, 0}, {0, 0, 1, 9, 0, 4, 5, 7, 0}, };
     **/
    public static int[][] GRID_TO_SOLVE = { { 5, 3, 0, 0, 7, 0, 0, 0, 0 }, { 6, 0, 0, 1, 9, 5, 0, 0, 0 },
            { 0, 9, 8, 0, 0, 0, 0, 6, 0 }, { 8, 0, 0, 0, 6, 0, 0, 0, 3 }, { 4, 0, 0, 8, 0, 3, 0, 0, 1 },
            { 7, 0, 0, 0, 2, 0, 0, 0, 6 }, { 0, 6, 0, 0, 0, 0, 2, 8, 4 }, { 0, 0, 0, 4, 1, 9, 0, 0, 5 },
            { 0, 0, 0, 0, 8, 0, 0, 7, 9 } };
    private int[][] board;
