...
func TestHandler(t *testing.T) {
	...
	expected := "Hello World, Sudev's first website"
...
func TestRouter(t *testing.T) {
	...
	// Need more understanding on the defer statement
...
func TestRouterForNonExistentRoute(t *testing.T) {
	...
	fmt.Println("Testingn non existing Router")
